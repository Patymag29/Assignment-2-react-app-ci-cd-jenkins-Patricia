...
test('renders my name on the page', () => {//test case to check if the name is rendered on the page
  ...
  const nameElement2 = screen.getByText(/Course: TECH2102 - Enterprise - Winter 2026/i); //get the element that contains the course name using a regular expression to ignore case
